...
use Owlookit\Tiptoppay\Enum\TrInitiatorCode;
use Owlookit\Tiptoppay\Library;
...
class LibraryTest extends TestCase
{
    ...
    public function testCreatePaymentByToken2Step()
    {
        ...
        $data = new TokenPayment(100, 'KZT', '100', '100', TrInitiatorCode::BY_CARDHOLDER);
    ...
    public function testPaymentsCardsCharge()
    {
        ...
        $result = $library->paymentsCardsCharge(new CardsPayment(1, 'KZT', '0.0.0.0', '123'));
    ...
    public function testOrdersCreate()
    {
        ...
        $result = $library->ordersCreate(new OrderCreate(1, 'KZT', 'asdf'));
