...
use Owlookit\Tiptoppay\Enum\CorrectionReceiptType;
use Owlookit\Tiptoppay\Enum\CorrectionType;
use Owlookit\Tiptoppay\Enum\TaxationSystem;
use Owlookit\Tiptoppay\Enum\VatRate;

/**
 * Параметры формирования чека/состав чека.
 * @see https://kassir.tiptoppay.kz/#correctionreceiptdata
 */
